...
namespace BarberHub.Migrations
{
    ...
    [Migration("20250729225823_Major changes in Reviews")]
    partial class MajorchangesinReviews
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BarberHub.Models.Review", b =>
                {
                    ...
                    b.HasOne("BarberHub.Models.User", "ReviewedUser")
                        .WithMany("ReceivedReviews")
                        .HasForeignKey("ReviewedUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BarberHub.Models.User", "ReviewerUser")
